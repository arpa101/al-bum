...
<div class="content-wrapper">
  <section class="content">
    ...
    <div class="card card-primary">
      ...
      <!-- /.card-header -->
      <!-- form start -->
      <form class="form" action="{{route("file.create")}}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="card-body">
          <div class="form-group">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2" style="width: 100%;" name="selecct">
                  @foreach($data1 as $item1)
               <option>{{$item1['subfolderName']}}</option>
               @endforeach
                </select>
              </div>
